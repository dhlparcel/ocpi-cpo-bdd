...
import com.extrawest.bdd_cpo_ocpi.validation.response.VersionResponseBddHandler;
...
import static com.extrawest.bdd_cpo_ocpi.exception.ApiErrorMessage.INVALID_INCOMING_FACTORY;
import static com.extrawest.bdd_cpo_ocpi.exception.ApiErrorMessage.INVALID_OUTGOING_FACTORY;
import static com.extrawest.bdd_cpo_ocpi.exception.ApiErrorMessage.NOT_MATCHING_MODEL_CONSTRAINT;
import static com.extrawest.bdd_cpo_ocpi.models.enums.ImplementedMessageType.VERSION;
...
//    private final CredentialsResponseBddHandler credentialsResponseBddHandler;
    ...
    public AssertionAndValidationServiceImpl(VersionResponseBddHandler versionResponseBddHandler) {
        this.versionResponseBddHandler = versionResponseBddHandler;
    }
